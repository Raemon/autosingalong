...
export const useEventListener = <K extends keyof WindowEventMap>(
  ...
  element: Window | HTMLElement = typeof window !== 'undefined' ? window : null as unknown as Window
) => {
  ...
  useEffect(() => {
    ...
    return () => element.removeEventListener(eventName, eventListener as EventListener);
  }, [eventName, element]);
};