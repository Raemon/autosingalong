...
const Header = () => {
  ...
  const headerClasses = isScriptPage
    ? "px-4 pt-3 pb-2 flex flex-wrap items-center justify-between print:hidden border-b border-gray-300 mb-4 bg-white"
    : "px-4 pt-3 pb-2 flex flex-wrap items-center justify-between print:hidden border-b border-gray-500 mb-4";
  ...
  return (
    <header className={headerClasses}>
      <h1 className={`font-georgia text-2xl text-nowrap mr-auto lg:mr-0 mb-2 ${isScriptPage ? 'text-black' : ''}`}><Link href="/">Secular Solstice</Link></h1>
